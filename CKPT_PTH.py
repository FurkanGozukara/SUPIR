...
def setModelPath(model_path):    
    ...
    SUPIR_CKPT_PTH = fr'{model_path}/ashleykleynhans/SUPIR/open_clip_pytorch_model.bin' if model_path is not None else 'laion/CLIP-ViT-bigG-14-laion2B-39B-b160k/open_clip_pytorch_model.bin' 
