...
import torch
from  SUPIR.utils import devices, optimization, shared, sd_emphasis
...
class FrozenCLIPEmbedderWithCustomWordsBase(torch.nn.Module):
    ...
    def __init__(self, wrapped, hijack):
        ...
        self.hijack: optimization.StableDiffusionModelHijack = hijack
    ...
    def forward(self, texts):
        ...
        if any(x for x in texts if "(" in x or "[" in x): # and opts.emphasis != "Original":
            self.hijack.extra_generation_params["Emphasis"] = None #opts.emphasis
    ...
    def process_tokens(self, remade_batch_tokens, batch_multipliers):
        ...
        emphasis = sd_emphasis.get_current_option(None)()
